...
//    @Test
    ...
    public void piece2() {
        ...
        try {
            ...
            player.addNote(new Pitch('B').accidentalTranspose(-1).toMidiNote(), 162, 12);
            player.addNote(new Pitch('B').toMidiNote(), 174, 6);
            ...
            player.addNote(new Pitch('B').toMidiNote(), 270, 18);
